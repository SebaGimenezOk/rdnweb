      ...
      <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center  h-full px-4 md:flex-row'>
        ...
        <div className=''>
          ...
          <div className='flex my-4  text-white'>
            <button className='rounded-sm   p-2 mx-auto'><img src={parliament} alt="parlamento" width={'50%'} height={'50%'} className=' rounded-md' /> Parlamento Internacional </button>
            <button className='rounded-sm   p-2 mx-auto'><img src={euronews} alt="euronews"className='h-5 w-auto'/>Las noticias de Europa</button>
            <button className='rounded-sm   p-2 mx-auto'><img src={onublanco} alt="onu" className='h-15 w-auto' /> naciones unidas</button>
          </div>
        </div>
      </div>
    </div>
